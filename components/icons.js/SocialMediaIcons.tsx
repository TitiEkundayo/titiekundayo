...
export const EmailIcon = () => {
  return (
    <Link href="mailto:hi@titiekundayo.com" passHref={true}>
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="16"
        height="16"
        fill="currentColor"
        className={`bi bi-envelope-fill me-3 ${styles.secColor}`}
        viewBox="0 0 16 16"
      >
  ...
  return (
    <Link href="https://www.linkedin.com/in/titilayo-ekundayo/" target="_blank" rel="noreferrer noopener">
      <svg
        ...
        height="16"
        fill="currentColor"
        className={`bi bi-linkedin me-3 ${styles.secColor}`}
        viewBox="0 0 16 16"
      >
  ...
  return (
    <Link href="https://www.facebook.com/teas4me4life" target="_blank" rel="noreferrer noopener">
      <svg
        ...
        height="16"
        fill="currentColor"
        className={`bi bi-facebook me-3 ${styles.secColor}`}
        viewBox="0 0 16 16"
      >
  ...
  return (
    <Link href="https://www.instagram.com/titiekundayo/" target="_blank" rel="noreferrer noopener">
      <svg
        ...
        height="16"
        fill={`currentColor`}
        className={`bi bi-instagram ${styles.secColor}`}
        viewBox="0 0 16 16"
      >
