          ...
          <div className="col">
            ...
            /> */}
              {/* <Image
                ...
                mx-lg-auto d-lg-block d-md-block d-sm-block d-xs-block`}
                src={HeroImgDesktop}
                alt=""
              /> */}
              <YouTubeIcon />
...
export const FeedbackForm = () => {
  return (
    <>
      <div className="container-fluid mt-5">
        <div className="container d-flex align-items-center justify-content-center">
          <div className="col-sm-12 col-md-12 col-lg-12 align-items-center justify-content-center">
...
// export default AbegWhoSendPage;
